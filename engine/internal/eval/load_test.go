...
func TestLoadSessionReadsRealPiSessionShapes(t *testing.T) {
	sessionDir := filepath.Join("..", "..", "..", "research", "archive", "sessions", "akg-durable-prompt-test-1")
...
func TestLoadSessionReadsHistoricalRealPiSessionShape(t *testing.T) {
	sessionDir := filepath.Join("..", "..", "..", "research", "archive", "sessions", "akg-recent-vs-stateless-seed1-a")
